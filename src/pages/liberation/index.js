...
export default function Liberation() {
  ...
  const processResourcesFilter = resources.filter((process) => process.status === 'ativo' && process.typeId === PROCESS_KEY && process.path.includes('liberacao')); 
